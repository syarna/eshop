...
class OrderServiceImplTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-012a-4c07-b546-54eb139d97b9", products, 1708568000L, "Safira Sudrajat");
        orders.add(order1);

        Order order2 = new Order("7f9e15bb-4b15-42f4-eebc-c3af385fb078", products, 1708570000L, "Safira Sudrajat");
        orders.add(order2);
    }
    ...
    void testUpdateStatusInvalidOrderId() {
        ...
        assertThrows(NoSuchElementException.class, () -> orderService.updateStatus("zzcz", OrderStatus.SUCCESS.getValue()));
        verify(orderRepository, times(0)).save(any(Order.class));
    }
